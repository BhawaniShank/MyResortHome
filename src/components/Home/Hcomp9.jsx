    ...
    return (
        ...
        >
            <div className="bg-[#787664] bg-opacity-50  w-full h-full py-10 px-5 md:py-28 lg:py-40 xl:py-32 rounded-lg shadow-lg text-center  mx-auto">
                <h1 className="text-4xl md:text-6xl  text-clay-red font-bold mb-2">Luxurious Rooms</h1>
                <hr className="lg:w-60 w-40 my-5 mx-auto bg-clay-red h-2" /> 
