...
const Hcomp6 = () => {
    return (
        <div className="flex justify-center items-center min-h-full p-2 md:p-10 w-full lg:p-20 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 p-3 md:p-6 lg:p-12 bg-blue-200 rounded-2xl shadow-lg">
                {[
                    {
