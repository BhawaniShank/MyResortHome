    ...
    return (
        <div className="container mx-auto max-w-[120em] p-6 md:p-20 ">
            ...
            <section className=" lg:w-[55%] md:mb-12">
                ...
                <button className="bg-desert-sand text-blue-600 border border-blue-600 py-2 px-6 rounded-lg hover:bg-blue-600 hover:text-white transition duration-300">
                    Discover More
                </button>
            </section>
