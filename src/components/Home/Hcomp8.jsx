...
const FacilityCard = ({ icon: Icon, text }) => (
  <div className="flex flex-col items-center rounded-lg p-10 md:p-16 xl:p-20 bg-gray-100 hover:bg-clay-red text-clay-red hover:text-white transition-colors duration-300">
...
const Hcomp8 = () => {
  return (
    <div className="flex flex-col w-full md:px-20 text-clay-red items-center p-8 ">
